...
export default function DeleteSeriesButton({ id, title }: DeleteSeriesButtonProps) {
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        message={`Êtes-vous sûr de vouloir supprimer "${title}" et tous ses albums ? Cette action est irréversible.`}
